...
class Rparser:
    ...
    def __init__(self):
        ...
        if not os.path.isfile('WESAD/readmes.csv'):
    ...
    def merge_with_feature_data(self):
        ...
        if os.path.isfile('WESAD/may14_feats4.csv'):
            feat_df = pd.read_csv('WESAD/may14_feats4.csv', index_col=0)
        else:
        ...
        merged_df.to_csv('WESAD/data.csv')
